...
if(length(args) < 2){
    ...
    cat ("Example: software/miniconda3/lib/R/bin/Rscript stat_relative_abundance_of_samples_in_clusters.R MultiSamplesClusterDisBar/clusters.csv relative.xls\n")
    quit("no")
}
